...
2026-04-27: image with uart1 communication of class, conf and jpg

## VST-BASE local layout

This folder is the VST-BASE-local GV2 package. The upstream firmware tree and image generator live under `firmware/`, while the helper scripts live next to this README:
...
From the VST-BASE repository root, build and flash with:
